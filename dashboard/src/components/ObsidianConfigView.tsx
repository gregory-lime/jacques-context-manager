...
function ConfigVerticalLayout({
  ...
  return (
    <Box flexDirection="column">
      ...
      <Box marginTop={1}>
        {isManualMode ? (
          <Text color={MUTED_TEXT}>[Enter] Confirm [Esc] Cancel</Text>
        ) : (
...
function ConfigHorizontalLayout({
  content,
  terminalWidth = 80,
  showVersion,
  isManualMode,
  ...
  // Bottom controls change based on mode
  const bottomControlsText = isManualMode
