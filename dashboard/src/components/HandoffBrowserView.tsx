...
function BrowserVerticalLayout({
  ...
  return (
    <Box flexDirection="column">
      ...
      <Box marginTop={1}>
        <Text color={MUTED_TEXT}>[↑↓] Navigate [Enter] Copy [Esc] Back</Text>
      </Box>
    </Box>
  );
}
...
function BrowserHorizontalLayout({
  ...
  // Bottom controls for handoff browser
  const bottomControlsText = "[Enter] Copy [Esc] Back";
  ...
  return (
    <Box flexDirection="column">
      ...
      <Box>
        ...
        <Text color={MUTED_TEXT}> Copy </Text>
